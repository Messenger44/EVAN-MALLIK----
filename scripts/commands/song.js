...
module.exports.run = async function ({ api, event, args }) {
    if (args.length == 0 || !args) return api.sendMessage('» আসসালামু আলাইকুম আপনি কি গান শুনতে চান তার ২/১ লাইন লিখেন এভাবে.Song সুহাসীনি ✅💯!', event.threadID, event.messageID);
